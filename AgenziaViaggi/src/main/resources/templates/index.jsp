...
<body>
    ...
    <video autoplay muted loop  id="video-back">
            <source src="static/video/aereo 2.mp4" type="video/mp4" />
        </video>
        <!-- divisione in classi-->
        <div class="content">
            <h2>
    ...
    <section id="testoViaggi">
        ...
        <h2>  Perché scegliere l'Agenzia Viaggi da Sogno?   </h2>
        <p>

            Agenzia Viaggi da Sogno offre una imperdibile gamma di itinerari tra cui scegliere la vostra prossima vacanza! Da più di trent'anni proprone mete sempre nuove a prezzi super vantaggiosi, unendo
            comodità e divertimento. </br> 
    ...
    <section id="immagini">
        ...
        <img src="static/image/berlino4.jpg" width="1471px" height="400px" align="top" />
        <!-- le altre tre immagini sono allineate, senza spazi l'una dall'altra -->
        <img src="static/image/parigi.jpg" width="450px" height="200px" align="left" hspace="0" />
        <img src="static/image/siviglia.jpg" width="571px" height="200px" align="left" hspace="0" />
        <img src="static/image/edimburgo.jpg" width="450px" height="200px" align="left" hspace="0" />
