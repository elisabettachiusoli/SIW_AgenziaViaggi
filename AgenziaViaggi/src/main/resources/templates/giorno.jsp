...
<head>
    ...
    <title>Giorno</title>
    <link rel="stylesheet" href="static/css/giorno.css">
...
<nav>
    ...
    <section id="icona">
        <img src="static/image/luogo.png" width="45" height="50" hspace="15" /> Zona: quartiere Louvre e L'ile de la cité
        <img src="static/image/orario.png" width="50" height="50" hspace="15" /> Durata visita guidata: 3 ore. Partenza alle ore 08:30
        <img src="static/image/money.png" width="50" height="50" hspace="15" /> Prezzo: 40 euro
    </section>
