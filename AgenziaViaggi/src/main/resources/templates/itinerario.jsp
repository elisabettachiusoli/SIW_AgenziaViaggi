...
<head>
    ...
    <link rel="stylesheet" href="static/css/itinerario.css" />
</head>
<body>
<nav>
    ...
    <section id="icona">
        <img src="static/image/calendar.png" width="50px" height="50px" hspace="15px" />  Dal 20 luglio al 23 giugno
        <img src="static/image/finePrenotazione.png" width="50px" height="50px" hspace="15px" />  Prenotazioni fino al 23 giugno
        <img src="static/image/guidaIcona.png" width="50px" height="50px" hspace="15px" /> Guida: <a href="guida.jsp"> Matteo Rossi</a>
        <img src="static/image/money.png" width="50px" height="50px" hspace="15px" /> Prezzo: 500 euro
