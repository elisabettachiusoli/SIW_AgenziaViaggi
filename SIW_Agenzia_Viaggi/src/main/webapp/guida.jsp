...
<nav>
        ...
        <div class="titolo">
            <img src="logo 2.jpg" width="80px" height="70px" align="left" hspace="40px" /> <h2> Agenzia Viaggi da Sogno </h2>
        </div>
    ...
    <div class="wrapper">
        <div class="box">
            <div class="box-img">
                <img src="stili/guida.png" height="600">
            </div>
            <div class="box-text">
                <h1>Matteo Rossi</h1>
                <h2>Informazioni</h2>
                <div class="info">
                    <div class="dati">
                        <h3>Email</h3>
                        <p>matteo.rossi@gmail.com</p>
                        <h3>Numero di Telefono</h3>
                        <p>338 428 4631</p>
                        <h3>Matricola</h3>
                        <p>052684</p>
                        <h3>Lingue parlate</h3>
                        <p>Italiano, inglese, spagnolo, tedesco</p>
                        <h3>Itinerari attuali</h3>
                        <p><a href="itinerario.jsp">Berlino</a>, Londra, Madrid</p>
                    </div>
                </div>
            </div>
        </div>
