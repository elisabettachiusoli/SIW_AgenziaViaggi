...
<head>
    ...
    <title>Team</title>
    <link rel="stylesheet" href="stili/guideTeam.css">
...
<nav>
    ...
    <div class="column">
        <div class="card">
            <img id="img" src="stili/avatar2.png" alt="">
    ...
    <div class="column">
        <div class="card">
            <img id="img" src="stili/avatar3.png" alt="">
    ...
    <div class="column">
        <div class="card">
            <img id="img" src="stili/avatar1.png" alt="">
